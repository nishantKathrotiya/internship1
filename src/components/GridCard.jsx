...
const GridPatternDemo = ({title , count}) => {
    ...
    return (
        <div className=" responsiveGrid relative flex w-[25%] h-[95%] m-5 max-w-xs max-h-[200px] pb-1 items-center justify-center rounded-lg border overflow-hidden bg-white  p-20">
